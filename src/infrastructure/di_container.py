...
from src.infrastructure.repositories.jupyter_sandbox_repository import JupyterSandboxRepository
...
class DIContainer:
    ...
    def get_llm_repository(self, api_key: str | None = None, endpoint: str | None = None) -> LLMRepository:
        """
        ...
        if self._llm_repository is None:
            # Azure OpenAI実装を使用
            from src.infrastructure.repositories.openai_llm_repository import OpenAILLMRepository
            self._llm_repository = OpenAILLMRepository(api_key=api_key, endpoint=endpoint)
    ...
    def get_describe_dataframe_use_case(self) -> 'DescribeDataframeUseCase':
        ...
        """
        from src.application.use_cases.describe_dataframe import DescribeDataframeUseCase
